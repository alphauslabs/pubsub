...
// // 		if err == nil {
// // 			glog.Infof("[INFO] Message %d published successfully: ID-%s", id, res.MessageId)
// // 			return
// // 		}
// // 		glog.Infof("[ERROR] Message %d failed to publish: %v", id, err)
...
// 	glog.Infof("Active endpoints: %v", activeEndpoints)
...
// 			glog.Infof("Failed to close connection: %v", err)
// 		}
// 	}

// 	duration := time.Since(startTime)

// 	glog.Infof("[SUMMARY] Total Messages: %d", *numMessages)
// 	glog.Infof("[SUMMARY] Total Time: %.2f seconds", duration.Seconds())
// 	glog.Infof("[SUMMARY] Throughput: %.2f messages/second", float64(*numMessages)/duration.Seconds())
// }
