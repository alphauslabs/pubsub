...
const (
	TopicService_CreateTopic_FullMethodName = "/pubsub.TopicService/CreateTopic"
	TopicService_GetTopic_FullMethodName    = "/pubsub.TopicService/GetTopic"
	TopicService_ListTopics_FullMethodName  = "/pubsub.TopicService/ListTopics"
	TopicService_UpdateTopic_FullMethodName = "/pubsub.TopicService/UpdateTopic"
	TopicService_DeleteTopic_FullMethodName = "/pubsub.TopicService/DeleteTopic"
)
...
func (c *topicServiceClient) DeleteTopic(ctx context.Context, in *DeleteTopicRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedTopicServiceServer) DeleteTopic(context.Context, *DeleteTopicRequest) (*emptypb.Empty, error) {
...
var TopicService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pubsub.TopicService",
